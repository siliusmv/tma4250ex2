...
The Strauss model is a model used
...
(ref:repulsive-test) Empirical $\mathbf{L}$-function for the biological cell data along with empirical 0.9-confidence intervals for the $\mathbf{L}$-function. Thes are made from simulation of 100 Strauss event RF models with parameters AHAHJASHDSDHF.

\todo[inline]{Fill out figure caption}
