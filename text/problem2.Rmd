...
From these realisations it seems as if the posterior distribution generates less pine trees overall than does the prior distribution. Except from this observations, it is difficult to say anything categorical about the differences between the realisations, just from looking at the figures. However, as the posterior model incorporates information from the observed number of pine trees, as well as the probability of making an observation, in each grid node, we should expect it to be more accurate than the prior model.
